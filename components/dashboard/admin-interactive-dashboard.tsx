...
export function AdminInteractiveDashboard({ user, profile, initialData }: { user: any, profile: any, initialData: any }) {
  ...
  const { data: dashboardData, isLoading, error, refetch } = useAdminDashboard(orgId, initialData);
