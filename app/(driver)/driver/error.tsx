...
/**
 * Driver portal route-level error boundary.
 * Catches errors within the /driver route group.
 */
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 p-6 text-center bg-background">
      ...
      <div className="flex flex-col gap-1 max-w-xs">
        <h2 className="text-base font-bold text-on-surface">Shift data error</h2>
        <p className="text-xs text-on-surface/60">
          {error.message || 'An error occurred loading your route. Please retry.'}
        </p>
      </div>
      <button
        onClick={reset}
